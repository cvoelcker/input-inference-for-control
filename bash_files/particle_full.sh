...
## linear
python scripts/run_particle_i2c.py --num-particles 500 --num-policy-samples 10 --batch-size 16 --horizon 100 --log-every 1 --em-steps 100 --env-name LinearDisturbed --type mixture --smoothing smoothing --init-alpha 0.0001 --components 1 --init-policy-variance 10000 --log-dir mixture_linear_s
